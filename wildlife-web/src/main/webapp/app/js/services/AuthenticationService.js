          ...
          return {
            login : function(credentials) {
              ...
              if (credentials.username === "claire") {
                return Session.create("000001", "00000000-0000-0000-0000-000000000001", "admin",
                    "Claire Taylor");
              } else if (credentials.username === "sherry") {
                return Session.create("000001", "00000000-0000-0000-0000-000000000002", "member",
                    "Sherry Wang");
              } else {
                return null;
              }
            ...
            isAuthorized : function(authorizedRoles) {
              if (authorizedRoles == undefined || authorizedRoles.length === 0) {
                ...
                return (this.isAuthenticated() && (authorizedRoles.indexOf(Session.userRole) !== -1 || authorizedRoles
                    .indexOf(USER_ROLES.all) !== -1));
              }
            }
          };
        });
